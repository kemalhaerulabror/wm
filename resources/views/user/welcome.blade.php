        ...
        <div class="bg-white border border-gray-200 rounded-lg hover:shadow-md transition overflow-hidden">
            ...
            <div class="px-3 pb-3">
                <div class="flex space-x-2 items-center">
                    @if($product->stock > 0)
                        @auth
                        <a href="{{ route('products.detail', $product->slug) }}" class="flex-grow bg-yellow-600 hover:bg-yellow-700 text-white text-xs rounded py-2 px-3 transition flex justify-center items-center">
                            Beli
                        </a>
                        @else
                        <a href="{{ route('login') }}" class="flex-grow bg-yellow-600 hover:bg-yellow-700 text-white text-xs rounded py-2 px-3 transition flex justify-center items-center">
                            Login
                        </a>
                        @endauth
                        <livewire:cart.add-to-cart-button :productId="$product->id" />
